...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference("Clinic.count") do
      post clinics_url, params: { clinic: { address: @clinic.address, title: @clinic.title } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { address: @clinic.address, title: @clinic.title } }
